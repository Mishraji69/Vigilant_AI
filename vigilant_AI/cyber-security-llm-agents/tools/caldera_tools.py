...
# ─── Mock mode routing ───
# When MOCK_CALDERA=true, all functions come from mock_caldera.py instead
_MOCK_MODE = os.getenv("MOCK_CALDERA", "true").lower() in ("true", "1", "yes")

if _MOCK_MODE:
    from tools.mock_caldera import (
    ...
    # Real Caldera implementation follows below
    import subprocess
    import tiktoken
    import json
...
if not _MOCK_MODE:
    ...
    CALDERA_WORKING_FOLDER = "/tmp/caldera"
