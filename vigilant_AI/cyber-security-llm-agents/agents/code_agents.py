...
cmd_exec_agent = ConversableAgent(
    ...
    system_message="""You execute shell commands. To run a command, write ONLY:
exec_shell_command(command="<the full command>")

Do NOT say "I'll use" or "I will execute". Do NOT explain. Write ONLY the function call on a single line. After you see results, present them and say TERMINATE.""",
)
